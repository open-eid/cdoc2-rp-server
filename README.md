...
| smartid.client.timeoutSeconds                            |               | Max time the SID API may hold a session status request open (server-side long poll) before responding with the current status, in seconds                                     |
